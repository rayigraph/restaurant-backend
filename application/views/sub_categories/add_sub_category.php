                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="sub_category_name" required name="sub_category_name" placeholder="Enter a Sub Category Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
