                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" value="<?= $category->category_name ?>" class="form-control" id="category_name" required name="category_name" placeholder="Enter a Category Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <img  width="100" id="blah" src="<?= base_url().CATEGORY_PATH.$category->category_image ?>" alt="">
                                    </div>
                                </div>
                                <div class="form-group row">
