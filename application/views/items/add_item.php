                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="item_name" required name="item_name" placeholder="Enter a Item Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="unit_price" required name="unit_price" placeholder="Enter Unit Price">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="sub_category_id">Sub Category
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <select class="form-control default-select"  required id="sub_category_id" name="sub_category_id">
                                                    <option value="">Please select</option>
                                                    <?php
                                                    foreach($sub_categories as $sub_category){
                                                        $selected = "";
                                                        if($sub_cat_id && $sub_cat_id == $sub_category->id)
                                                        {
                                                            $selected = "selected";
                                                        }
                                                        ?>
